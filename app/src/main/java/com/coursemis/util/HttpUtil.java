...
public class HttpUtil {
     ...
     * 教师发送测验消息
     */
    public static String server_send_test_message = server + "/sendTestMessage.action";
    /**
     * 教师发送提问消息
     */
    public static String server_send_quiz_message = server + "/sendQuizMessage.action";
    /**
     * 教师发送反馈消息
     */
    public static String server_send_callback_message = server + "/sendCallBackMessage.action";
    /**
     * 教师获取反馈
     */
    public static String server_get_callback = server + "/getCallBack.action";
    /**
     * 教师获取成绩信息
     */
    public static String server_get_score = server + "/getScore.action";
    /**
     * 学生发送反馈
     */
    public static String server_send_callback = server + "/sendCallBack.action";
    /**
     * 学生获取测验
     */
    public static String server_get_test = server + "/getTest.action";
    /**
     * 学生发送测验
     */
