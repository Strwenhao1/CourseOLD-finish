    ...
    client.post(HttpUtil.server_getMedia, params,
            new JsonHttpResponseHandler(){
                ...
                public void onSuccess(int arg0, JSONObject arg1) {
                    ...
                    if(object.length()==0){
                        Toast.makeText(StudentManager.this,"当前没有任何资源共享!", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(StudentManager.this,UploadAudioActivity.class);
                       ...
                       StudentShareFragement fragment = new StudentShareFragement();
                        ...
                        bundle.putStringArrayList("mediainfolist", list);// ("fragData",fragData);
...
//                        Intent intent = new Intent(StudentManager.this,TCourseSignInActivity.class);
...
//                        startActivity(intent);
                        ...
                        Bundle bundle = new Bundle();
                        bundle.putStringArrayList("studentCourseSignInInfo", list);// ("fragData",fragData);
                        fragment.setArguments(bundle);
                        transaction.replace(R.id.v4_drawerlayout_frame,fragment);
                        transaction.commit();
